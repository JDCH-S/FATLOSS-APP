 ...
 *   drainedRatio  canned foods only: drained grams per gram of the label's net weight (tuna 0.7: 160 g can ->
 *             112 g; legumes 0.6: 400 g can -> 240 g). Weekly need and product pack sizes are drained grams; the
 *             price script converts a scraped net weight with this ratio
 *   gPerMl    liquids sold by volume whose macros are per 100 g (oil): grams per ml for converting a scraped
 *             volume; other liquids count 1 ml = 1 g
...
(function (root) {
  ...
  const FOODS = [
    ...
    { id: 'tuna_water', name: 'Tuna in water (drained)', nameNl: 'Tonijn in water', category: 'protein', kcal: 108, protein: 25, carbs: 0, fat: 1, fibre: 0, slots: ['protein'], meals: ['main'], fill: 3, maxPerMeal: 250, drainedRatio: 0.7, source: 'Search snippet for canned tuna in water, drained: 116 kcal, 25.5 P, 0.8 F (USDA-type value); another brand 99 kcal, 24 P, 0.5 F' },
    ...
    { id: 'chickpeas', name: 'Chickpeas (canned, drained)', nameNl: 'Kikkererwten', category: 'carb', kcal: 121, protein: 6.4, carbs: 15, fat: 2.2, fibre: 7.7, slots: ['carb'], meals: ['main'], fill: 4, maxPerMeal: 400, drainedRatio: 0.6, source: 'Bonduelle kikkererwten label: 121 kcal, 6.4 P, 15 C, 2.2 F, 7.7 fibre' },
    { id: 'kidney_beans', name: 'Kidney beans (canned, drained)', nameNl: 'Rode kidneybonen', category: 'carb', kcal: 100, protein: 7.5, carbs: 13, fat: 0.5, fibre: 6.5, slots: ['carb'], meals: ['main'], fill: 4, maxPerMeal: 400, drainedRatio: 0.6, source: 'fatsecret.be Boni rode kidneybonen 100 kcal; AH Terra kidneybonen label 101 kcal, 8 P, 12 C, 0.8 F, 7 fibre (snippet)' },
    ...
    // ---------- fat ----------
    { id: 'olive_oil', name: 'Olive oil', nameNl: 'Olijfolie', category: 'fat', kcal: 900, protein: 0, carbs: 0, fat: 100, fibre: 0, slots: ['fat'], meals: ['main'], fill: 1, maxPerMeal: 25, gPerMl: 0.92, source: 'EU labelling: 100 g fat = 900 kcal per 100 g (labels per 100 ml show ~824 kcal, 91.6 g fat)' },
